-- ulifer admin hacks is a exclusive script for UliferHub
	if IY_LOADED and not _G.IY_DEBUG == true then
		    error("ulifer admin hacks is already running!",0)
		return
	end
	...
	if not game:IsLoaded() then
		...
		notLoaded.Text = 'ulifer admin hacks is waiting for the game to load'
		game.Loaded:Wait()
		notLoaded:Destroy()
	end
	...
	Title.TextSize = 18
	Title.Text = "ulifer admin hacks v"..ver
	...
	Logo.Image = "http://www.roblox.com/asset/?id=12663643214"
	...
	SaveChatlogs.MouseButton1Down:Connect(function()
		if writefileExploit() then
			if #scroll_2:GetChildren() > 0 then
				...
				local writelogs = '-- ulifer admin hacks chat logs for "'..placeName..'"\n'
				for _, child in pairs(scroll_2:GetChildren()) do
					writelogs = writelogs..'\n'..child.Text
				end
	...
	CMDs = {}
	CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = 'Invite to the ulifer hub support server.'}
